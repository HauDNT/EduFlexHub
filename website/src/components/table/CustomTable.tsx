      ...
      actionBar={
        <div className='flex justify-between w-full gap-4'>
          ...
          }
          {
            navigateToRestore && (
              <ActionButton
                action={"Navigate to Restore"}
                handleAction={handleNavigateToRestore}
              />
            )
          }
          {
            restoreItem && (
              <ActionButton
                action={"Restore"}
                handleAction={async () => handleRestore?.(itemSelected)}
              />
            )
          }
        </div>
          ...
          <div className="min-w-[1102px]">
            <Table>
              ...
              <TableHeader className="border-b border-gray-100 dark:border-white/[0.05]">
                <TableRow>
                  {(deleteItem || navigateToRestore) && tableData?.columns?.length > 0 && (
                    <TableCell
                      isHeader
