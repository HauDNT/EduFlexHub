...
const genderOptions = enumToOptions(GenderEnum, GENDER_LABELS);
...
const UpdateEmployeeForm = ({
  ...
  const handleFieldChange = createFieldChangeHandler(setUserData);
                ...
                <div>
                  ...
                  <p className="text-sm font-medium text-gray-800 dark:text-white/90">
                    <ToggleLabelInput
                      ...
                      fieldType={'input'}
                      onFieldChange={(value) => handleFieldChange('username', value as string)}
                    />
                  </p>
                </div>
                <div>
                  ...
                  <p className="text-sm font-medium text-gray-800 dark:text-white/90">
                    <ToggleLabelInput
                      ...
                      fieldType={'input'}
                      onFieldChange={(value) => handleFieldChange('fullname', value as string)}
                    />
                  </p>
                </div>
                <div>
                  ...
                  <p className="text-sm font-medium text-gray-800 dark:text-white/90">
                    <ToggleLabelInput
                      ...
                      fieldType={'input'}
                      onFieldChange={(value) => handleFieldChange('email', value as string)}
                    />
                  </p>
                </div>
                <div>
                  ...
                  <p className="text-sm font-medium text-gray-800 dark:text-white/90">
                    <ToggleLabelInput
                      ...
                      fieldType={'input'}
                      onFieldChange={(value) => handleFieldChange('address', value as string)}
                    />
                  </p>
                </div>
                <div>
                  ...
                  <p className="text-sm font-medium text-gray-800 dark:text-white/90">
                    <ToggleLabelInput
                      ...
                      fieldType={'input'}
                      onFieldChange={(value) => handleFieldChange('phone_number', value as string)}
                    />
                  </p>
                </div>
                <div>
                  ...
                  <p className="text-sm font-medium text-gray-800 dark:text-white/90">
                    <ToggleLabelInput
                      ...
                      onFieldChange={(value) => handleFieldChange('gender', value as GenderEnum)}
                    />
                  </p>
                </div>
                <div>
                  ...
                  <p className="text-sm font-medium text-gray-800 dark:text-white/90">
                    <ToggleLabelInput
                      ...
                      onFieldChange={(value) => handleFieldChange('username', value as RoleEnum)}
                    />
                  </p>
                </div>
              </div>
