...
import { FaCirclePlus, FaTrashArrowUp, FaArrowRotateLeft } from "react-icons/fa6";
import { FaTrash } from "react-icons/fa";

type ActionButtonType = 'Create' | 'Delete' | 'Navigate to Restore' | 'Restore'
...
export default function ActionButton({
  ...
  switch (action) {
    ...
    case "Restore":
      ...
      icon = <FaArrowRotateLeft size={20} color={'#ffffff'} />
      break
    case "Navigate to Restore":
      className += 'bg-blue-500 dark:border-white/[0.05] '
      icon = <FaTrashArrowUp size={20} color={'#ffffff'} />
      break
    default:
      break
  }
